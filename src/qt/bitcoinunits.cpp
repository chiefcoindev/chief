...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("CHIEF");
    case mBTC: return QString("mCHIEF");
    case uBTC: return QString::fromUtf8("μCHIEF");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("TheChiefCoins"));
    case mBTC: return QString(QObject::tr("Milli-TheChiefCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-TheChiefCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
